...
def plot_metrics(train_losses, val_losses, train_accs, val_accs, train_precs, val_precs, train_recs, val_recs):
    ...
    axs[1][0].plot(epochs, train_precs, color = 'green', linestyle = 'dashdot', label = 'train prec')
    axs[1][0].plot(epochs, val_precs, color = 'green', linestyle = 'solid', label = 'val prec')
    axs[1][1].plot(epochs, train_recs, color = 'gold', linestyle = 'dashdot', label = 'train rec')
    axs[1][1].plot(epochs, val_recs, color = 'gold', linestyle = 'solid', label = 'val rec')
...
def plot_metrics_late_fusion(losses, accs, precs, recs):
    ...
    _, axs = plt.subplots(2, 2, figsize = (15, 10))
    axs[0][0].plot(epochs, losses, color = 'blue', linestyle = 'solid', label = 'fusion loss')
    axs[0][1].plot(epochs, accs, color = 'red', linestyle = 'solid', label = 'fusion acc')
    axs[1][0].plot(epochs, precs, color = 'green', linestyle = 'solid', label = 'fusion prec')
    axs[1][1].plot(epochs, recs, color = 'gold', linestyle = 'solid', label = 'fusion rec')
